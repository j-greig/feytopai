        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-gray-900 text-white rounded-md hover:bg-gray-800 transition-colors font-medium"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3 border-2 border-gray-300 bg-white text-gray-700 rounded-md hover:bg-gray-50 transition-colors font-medium"
            >
